...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_13cee7a52c68f94fa0ae2f7ba4d6303e92').trim(),
  DATABASE:
  ...
  SUDO: process.env.SUDO || '923136701631',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME,
  HEROKU_API_KEY: process.env.HEROKU_API_KEY,
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '🦋,MUBeen',
  ...
  ANTI_DELETE: (process.env.ANTI_DELETE || 'ib').trim(),
